...
| Probleem                                                                     | Oplossing                                                                                                                                                                                                                                                                                                                                                                                                                           |
|------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Apple Silicon: VM start niet, box-architectuur mismatch (`arm64` vs `amd64`) | Controleer host + box-architectuur: `uname -m` en `vagrant box list`. Op Apple Silicon moet de box `arm64` zijn. Forceer opnieuw: `vagrant box remove bento/ubuntu-24.04 --provider virtualbox` en daarna `vagrant box add bento/ubuntu-24.04 --provider virtualbox --architecture arm64`. Installeer VirtualBox bij voorkeur via de officiële downloadpagina (Apple Silicon build), niet via een verouderde package-manager build. |
| Windows: `vagrant up` blijft hangen rond netwerk/adapter-setup               | Dit is meestal een Host-Only adapter race/driver issue. Run eerst `vagrant up` nog 1-2 keer. Blijft het hangen: controleer `VBoxManage list hostonlyifs`; als er geen actieve adapter is, open VirtualBox GUI eenmalig als Administrator en start de VM daar 1x, of herstel de VirtualBox network drivers (Host-Only/NDIS) en probeer opnieuw.                                                                                      |
